...
> Use o design system do projeto `appd-sjc` (versão 2): fundo branco, texto `#14161a`, superfície
...
> direta e contemporânea, quase de serviço público bem-feito: contraste alto, muito
> espaço em branco, hierarquia por tamanho de texto, cartões com canto suave e sombra
> discreta, nada decorativo na frente do conteúdo. **Evite** a estética de startup:
> fundo creme, serifa decorativa, degradê, vidro fosco, sombra pesada, ícone ilustrado
> colorido, foto de banco de imagem com pessoa sorrindo, ou faixa gigante ocupando a
> tela inteira antes do conteúdo. **Prefira** densidade honesta: a informação começa no primeiro terço da
> tela.
>
...
>    Item atual marcado por fundo tênue `#fdf2f2`, sublinhado espesso **e**
>    `aria-current="page"`. Um
...
>    nunca todos ao mesmo destino. Card com borda de 1px `#e2e5e9`, raio de 10px e sombra
>    discreta; sem ícone ilustrado.
...
> 7. **Rodapé** em `#14161a` com texto branco: endereço (Rua Acássia Pereira 136,
...
> de headings sem pular nível; foco visível com anel de 3px `#0f4c93` e 2px de folga em
...
- [ ] Nenhum card usa ícone ilustrado; a sombra é discreta, nunca pesada.
...
- **Os nove cards viraram uma grade uniforme sem distinção**: peça a separação em dois
  ...
  que entre cards.
- **Raio exagerado ou inconsistente**: use o painel de Tweaks para fixar 10px em bloco
  e 8px em botão — não gasta token.
- **Ficou creme e serifado**: reforce "fundo branco, Atkinson Hyperlegible, neutros
  cinza-frios" e cite o design system `appd-sjc` de novo.
